    ...
    public class StringBuilderTest {
        ...
        public void Merge_A_Test_Template_With_Test_KeyValuePairs_Into_0000001_Test_Document() {
            foreach (var index in Enumerable.Range(1, 1))
                PreBuiltTestTemplates.PopTemplatedDocumentAndNameValuePairsStack().StringBuilder_MergeTemplateWithNamedValuePairsIntoADocumentAndOptionalyTest(0);
        }

        [TestMethod]
        public void Merge_A_Test_Template_With_Test_KeyValuePairs_Into_0000010_Test_Document() {
            foreach (var index in Enumerable.Range(1, 10))
                PreBuiltTestTemplates.PopTemplatedDocumentAndNameValuePairsStack().StringBuilder_MergeTemplateWithNamedValuePairsIntoADocumentAndOptionalyTest(index);
        }
